import{c as a}from"./helpers-BSqnvA6D.js";const i=(e,t="success")=>{const s=a("div","toast glass"),r=t==="success"?"var(--success)":t==="error"?"var(--danger)":"var(--primary)";s.style.cssText=`
    position: fixed;
    bottom: 2rem;
    right: 2rem;
    padding: 1rem 2rem;
